...
#from common.ascii_art

from common.ascii_art import hangman_7_stages
def show_hangman(incorrect_guesses, hangman_art: list[str] = hangman_7_stages):
    if 0 <= incorrect_guesses < len(ascii_art.HANGMAN_PICS):
        return ascii_art.HANGMAN_PICS[incorrect_guesses]
    else:
        return "Error: Invalid number of guesses"

show_hangman(incorrect_guesses, hangman_art) 
